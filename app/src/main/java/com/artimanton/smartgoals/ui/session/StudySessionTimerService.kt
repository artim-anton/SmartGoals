...
import com.artimanton.smartgoals.util.Constants.ACTION_SERVICE_CANCEL
import com.artimanton.smartgoals.util.Constants.ACTION_SERVICE_START
import com.artimanton.smartgoals.util.Constants.ACTION_SERVICE_STOP
import com.artimanton.smartgoals.util.Constants.NOTIFICATION_CHANNEL_ID
import com.artimanton.smartgoals.util.Constants.NOTIFICATION_CHANNEL_NAME
import com.artimanton.smartgoals.util.Constants.NOTIFICATION_ID
import com.artimanton.smartgoals.util.pad
...
class StudySessionTimerService : Service() {
    ...
    var currentTimerState = mutableStateOf(TimerState.IDLE)
        private set
    var goalId = mutableStateOf<Int?>(null)
